...
namespace MindTouch.Clacks.Server.Async {
    public class SyncMultiCommandHandler : IAsyncCommandHandler {
        ...
        public SyncMultiCommandHandler(Connection connection, string command, string[] arguments, int dataLength, Action<IRequest, Action<IEnumerable<IResponse>>> handler, Action<IRequest, Exception, Action<IResponse>> errorHandler) {
